...
INSERT INTO CONTRATAM VALUES (null, '12345678901235', 'DESC15');
...
INSERT INTO EMPREGADO VALUES ('Pedro', '12345678902', tp_endereco('04108-041', 'Rua Américo Brasiliense', '320', 'São Paulo'), '12345678901239', 2800, tp_telefones(tp_telefone('(11)98567-1234')), NULL);
INSERT INTO EMPREGADO VALUES ('Maria', '34567891234', tp_endereco('30140-080', 'Rua dos Guajajaras', '1000', 'Belo Horizonte'), '12345678901237', 4000, tp_telefones(tp_telefone('(31)98765-4321')), NULL);
...
INSERT INTO EMPREGADO VALUES ('Lorena', '09876543210', tp_endereco('04567-123', 'Rua Augusta', '450', 'São Paulo'), '12345678901238', 3500.00, tp_telefones(tp_telefone('(11)94567-8912')), (SELECT REF(E) FROM EMPREGADO E WHERE CPF = '98765432101'));
...
gitINSERT INTO OFERECEM VALUES (TO_DATE('2023-04-17', 'YYYY-MM-DD'), 'SRV006', '006', 'L000000006');
...
INSERT INTO OFERECEM VALUES (TO_DATE('2023-04-20', 'YYYY-MM-DD'), 'SRV001', '001', 'L000000010');
